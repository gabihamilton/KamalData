...
// Wed Mar  1 09:22:56 2023 by ROOT version 6.26/06
// from TTree tree/all observables, signal
// found on file: tree_ggFG_mG2000_v3_MC2016.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tree_ggFG_mG2000_v3_MC2016.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("tree_ggFG_mG2000_v3_MC2016.root");
      }
